...
- Создание тренеров
- Блокировка/разблокировка тренеров
- Сброс паролей тренеров
- Просмотр списка всех тренеров

### TRAINER (Тренер)

- Вход в кабинет тренера (`/trainer`)
- Редактирование своего профиля (ФИО, телефон, примечания)
- Смена пароля
- Управление списком спортсменов (добавление, редактирование, удаление)
- Массовый импорт спортсменов из Excel-файла (формат: колонка A - ФИО, колонка B - Дата рождения)
- Ведение учёта нормативов по каждому спортсмену
