          ...
          <div className="flex items-center gap-3 sm:gap-4">
            {shouldShowAdminLink && (
              <button
                ...
                className="px-3 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors"
              >
                Админ-панель
              </button>
            )}
            ...
            <button
              ...
              disabled={loading}
              className="px-3 sm:px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 transition-colors"
            >
              {loading ? 'Выход...' : 'Выйти'}
            </button>
          </div>
